...
Un fois l'api lancé, j'ai créé depuis CartoGIS54 des méthodes qui vont appeler une requête `axios` vers fileAPI. Ces méthodes peuvent être vues en détails [ici](https://github.com/infogeo54/CartoGIS54/blob/master/src/fileAPI/index.js).
